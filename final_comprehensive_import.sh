...
PASSWORD="Covid19!#@$"
BASE_DIR="/Users/mk/Documents/GitHub/cancer-registry"
...
import_file "${BASE_DIR}/Validaion/Validation Rule.json" "Validation Rules (12 total - data quality assurance)"
