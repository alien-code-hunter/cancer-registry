...
files_to_import = [
    ...
    ("Program/Program Stage.json", "Program Stages (TRACKER elements only)"),
...
if fail_count == 0:
    ...
    print("\nFixed Issues:")
    print("  ✅ Dashboards: type fields added")
    print("  ✅ Program Stages: AGGREGATE data elements removed (143 TRACKER kept)")
    print("  ✅ Programs: CECAP renamed to Cervical Cancer Program")
else:
